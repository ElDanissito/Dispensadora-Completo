...
- [ ] **Branding / identidad visual** → guía fuente de verdad lista en [`especificaciones/identidad-visual-v1.md`](./especificaciones/identidad-visual-v1.md) (formaliza paleta/tipografía de `base.html`). **Decisión abierta:** la **marca compacta/símbolo** para favicon e íconos (§3, opciones A/B/C — el wordmark no encoge a 16px). Assets digital-first a producir: favicon set, imagen OG 1200×630, wordmark SVG (2 lockups), avatar. Diseño en Claude Design → un agente cablea favicon/OG/manifest en el `<head>`.
