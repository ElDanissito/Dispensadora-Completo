 ...
 * PASO 5: Verificar el token v2 y, si es OK, DISPENSAR con CONFIRMACION por sensor.
 *
 ...
 *   5. NUEVO (paso 5): al mover cada unidad, ESPERA la caida del producto en el
 *      E18-D80NK dentro de un TIMEOUT:
 ...
 * verificar_token() (paso 9), que retorna OK ANTES de que dispensemos. Un
 * DISPENSE_FAIL NO "devuelve" el jti: el token queda consumido y el fallo se
 * gestiona como incidencia (reembolso), como manda el contrato.
 *
...
void setup() {
  ...
  Serial.println();
  Serial.println("=== PASO 5: verificacion + dispensado con sensor ===");
